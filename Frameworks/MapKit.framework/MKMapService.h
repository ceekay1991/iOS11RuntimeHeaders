...
- (id)_ticketForReverseGeocodeCoordinate:(struct CLLocationCoordinate2D { double x1; double x2; })arg1 floorOrdinal:(int)arg2 includeEntryPoints:(bool)arg3 includeETA:(bool)arg4 preserveOriginalLocation:(bool)arg5 traits:(id)arg6;
...
- (id)ticketForNearestTransitStation:(id)arg1 coordinate:(struct CLLocationCoordinate2D { double x1; double x2; })arg2 includeETA:(bool)arg3 traits:(id)arg4;
