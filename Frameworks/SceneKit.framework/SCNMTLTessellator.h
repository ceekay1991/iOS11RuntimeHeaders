...
- (void)dealloc;
- (void)draw:(struct { id x1; unsigned long long x2; id x3; id x4; id x5; })arg1;
...
- (void)subdivisionSurfaceTessellationDraw:(struct { id x1; unsigned long long x2; id x3; id x4; id x5; })arg1;
