...
- (void).cxx_destruct;
- (void)_fetchFileProviderMessageInterfaces:(id)arg1 completionHandler:(id /* block */)arg2;
- (void)_fetchFileProviderMessageInterfacesForItemID:(id)arg1 completionHandler:(id /* block */)arg2;
...
- (void)_fetchRemoteMessageInterfaceProviderWithIdentifier:(id)arg1 handler:(id /* block */)arg2;
...
- (void)fetchFileProviderMessageInterfacesForItem:(id)arg1 completionHandler:(id /* block */)arg2;
