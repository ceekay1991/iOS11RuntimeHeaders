...
- (id)initWithContext:(struct LSContext { struct LSDatabase {} *x1; }*)arg1 node:(id)arg2 bundleClass:(const unsigned int*)arg3 desiredDisplayName:(id)arg4;
...
- (bool)showExtensionWithContext:(struct LSContext { struct LSDatabase {} *x1; }*)arg1;
