...
+ (id)settingsWithLikenessResolver:(id)arg1 likenessRenderer:(id)arg2 threeDTouchEnabled:(bool)arg3;
+ (bool)threeDTouchEnabledDefaultValue;

- (void).cxx_destruct;
- (id)contactStore;
- (id)initWithLikenessResolver:(id)arg1 likenessRenderer:(id)arg2 threeDTouchEnabled:(bool)arg3;
- (id)likenessRenderer;
- (id)likenessResolver;
- (id)personaStore;
