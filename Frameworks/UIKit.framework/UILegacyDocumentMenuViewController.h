...
@interface UILegacyDocumentMenuViewController : UIViewController <UIActionSheetPresentationControllerDelegate, _UIDocumentPickerRemoteViewControllerContaining> {
    NSMutableArray * _auxiliaryOptions;
    _UIResilientRemoteViewContainerViewController * _childViewController;
    <UILegacyDocumentMenuDelegate> * _delegate;
    bool  _dismissDelegateCalled;
    unsigned long long  _documentPickerMode;
    bool  _ignoreApplicationEntitlementForImport;
    bool  _sourceIsManaged;
    NSURL * _uploadURL;
    <UILegacyDocumentMenuDelegate> * _weak_delegate;
}
...
@property (nonatomic) <UILegacyDocumentMenuDelegate> *delegate;
