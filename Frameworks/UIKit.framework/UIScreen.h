...
@interface UIScreen : NSObject <DebugHierarchyObject, UICoordinateSpace, UITraitEnvironment, _UIFocusEnvironmentInternal, _UIFocusEnvironmentPrivate, _UIFocusRegionContainer, _UITraitEnvironmentInternal> {
