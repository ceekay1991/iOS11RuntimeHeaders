...
@property (nonatomic) struct { double x1; double x2; bool x3; bool x4; double x5; double x6; double x7; double x8; double x9; double x10; } parameters;
@property (nonatomic) double tension;
@property (nonatomic) bool usesDampingRatioAndResponse;

+ (id)descriptionWithSpringAnimationParameters:(struct { double x1; double x2; bool x3; bool x4; double x5; double x6; double x7; double x8; double x9; double x10; })arg1;
+ (id)descriptionWithTension:(double)arg1 friction:(double)arg2;

- (double)friction;
- (struct { double x1; double x2; bool x3; bool x4; double x5; double x6; double x7; double x8; double x9; double x10; })parameters;
- (void)setFriction:(double)arg1;
- (void)setParameters:(struct { double x1; double x2; bool x3; bool x4; double x5; double x6; double x7; double x8; double x9; double x10; })arg1;
