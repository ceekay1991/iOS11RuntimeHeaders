...
- (void)gestureTracker:(AVInteractiveTransitionGestureTracker *)arg1 didTrackPercentComplete:(double)arg2 translation:(struct CGPoint { double x1; double x2; })arg3 rotation:(double)arg4;
