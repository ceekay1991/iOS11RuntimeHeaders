...
- (void)stillImageCoordinator:(BWStillImageCoordinatorNode *)arg1 willBeginCaptureForSettings:(FigCaptureStillImageSettings *)arg2 resolvedCaptureSetings:(BWStillImageCaptureSettings *)arg3 photoManifest:(NSArray *)arg4;
