...
- (void)startOperation:(void *)arg1 toCreateFolderWithName:(void *)arg2 underParent:(void *)arg3 reply:(void *)arg4; // needs 4 arg types, found 10: <FPOperationClient> *, NSString *, FPItemID *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, FPItem *, NSError *, void*
...
- (void)startOperation:(void *)arg1 toRenameItem:(void *)arg2 toNewName:(void *)arg3 reply:(void *)arg4; // needs 4 arg types, found 9: <FPOperationClient> *, FPItemID *, NSString *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSError *, void*
- (void)startOperation:(void *)arg1 toReparentItems:(void *)arg2 underParent:(void *)arg3 reply:(void *)arg4; // needs 4 arg types, found 10: <FPOperationClient> *, NSArray *, FPItemID *, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSDictionary *, NSError *, void*
