...
- (oneway void)requestImageForItemIndex:(void *)arg1 reply:(void *)arg2; // needs 2 arg types, found 9: unsigned long long, id /* block */, /* Warning: Unrecognized filer type: '<' using 'void*' */ void*, void, id /* block */, NSArray *, BKSAnimationFenceHandle *, long long, void*
