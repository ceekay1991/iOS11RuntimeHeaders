...
+ (bool)_shouldReloadBagForSetStorefront:(id)arg1 originalStorefront:(id)arg2;
...
- (id)_URLWithCookieNames:(id)arg1 storeFront:(id)arg2;
- (void)_assertIfKey:(id)arg1 doesNotReturnValueType:(unsigned long long)arg2;
- (void)_assertIfKeyWasNotRegistered:(id)arg1;
- (id)_createLoadBagURLOperationWithCookieNames:(id)arg1 storeFront:(id)arg2;
