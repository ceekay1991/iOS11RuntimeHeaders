...
- (id)_searchable_ticketForReverseGeocodeCoordinate:(struct { double x1; double x2; })arg1 floor:(int)arg2 includeEntryPoints:(bool)arg3 shiftLocationsIfNeeded:(bool)arg4 includeETA:(bool)arg5 preserveOriginalLocation:(bool)arg6 traits:(id)arg7;
...
- (id)ticketForNearestTransitStation:(id)arg1 coordinate:(struct { double x1; double x2; })arg2 includeETA:(bool)arg3 traits:(id)arg4;
...
- (id)ticketForReverseGeocodeCoordinate:(struct { double x1; double x2; })arg1 floor:(int)arg2 includeEntryPoints:(bool)arg3 shiftLocationsIfNeeded:(bool)arg4 includeETA:(bool)arg5 preserveOriginalLocation:(bool)arg6 traits:(id)arg7;
