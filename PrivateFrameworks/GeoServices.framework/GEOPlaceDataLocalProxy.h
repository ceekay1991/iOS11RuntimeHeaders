...
- (void)_requestIdentifiersFromNetwork:(id)arg1 resultProviderID:(int)arg2 includeETA:(bool)arg3 traits:(id)arg4 auditToken:(id)arg5 finished:(id /* block */)arg6 error:(id /* block */)arg7;
