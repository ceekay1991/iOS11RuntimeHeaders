...
- (id)initForNearestTransitStationWithLine:(id)arg1 coordinate:(struct { double x1; double x2; })arg2 includeETA:(bool)arg3 traits:(id)arg4;
...
- (id)initWithReverseGeocodeCoordinate:(struct { double x1; double x2; })arg1 floorOrdinal:(int)arg2 includeEntryPoints:(bool)arg3 includeETA:(bool)arg4 preserveOriginalLocation:(bool)arg5 traits:(id)arg6;
